...
const envSchema = z.object({
  ...
  GRAFANA_QBITTORRENT_LABEL_SELECTOR: z.string().optional(),
...
export const env = {
  ...
  grafanaQbittorrentLabelSelector: parsed.data.GRAFANA_QBITTORRENT_LABEL_SELECTOR,
  ...
  grafanaMonitorPollMs: parsed.data.GRAFANA_MONITOR_POLL_MS ?? 15_000,
  grafanaMonitorLookbackMs: parsed.data.GRAFANA_MONITOR_LOOKBACK_MS ?? 5 * 60_000,
  grafanaMonitorLimit: parsed.data.GRAFANA_MONITOR_LIMIT ?? 50,
